...
#
# # 2. 筛选并保存 meta_Beauty.json.gz 中匹配商品
# meta_input = "meta_Movies_and_TV.json.gz"
# meta_output = "filtered_meta_Movies_and_TV.json.gz"
#
...
# review_input = "reviews_Movies_and_TV_5.json.gz"
# review_output = "filtered_reviews_Movies_and_TV_5.json.gz"
#
...
# meta_file_path = 'filtered_meta_Movies_and_TV.json.gz'
#
# # ----------------------- Step 1: 读取用户序列 -----------------------
# user_sequences = {}
